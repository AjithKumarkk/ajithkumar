# Ajith Kumar – Portfolio Project Details
> This file contains the updated content for all 5 main projects.
> Each section includes: Card Display (shown on the main projects page) and Modal Popup (shown when clicking a project card).

---

## 1. Rotted – A Brain Rot Simulator

### 📋 Card Display (Main Projects Page)
...
**Platform Badge:** PC (Steam)

**Store Link:** https://store.steampowered.com/app/4474330/Rotted__A_Brain_Rot_Simulator/
...
**Technologies Used:**
`Unity` `C#` `Steam Achievements` `Steam Cloud` `Steam Leaderboards` `Steamworks SDK` `Localization` `Roguelite Systems` `Procedural Generation`
...
> *Developed as part of the Sector4Interactive team. Officially credited in the game's release.*
...
**Card Description:**
A first-person psychological horror game built in Unity that focuses on atmosphere, tension, and player-driven fear. The game dynamically reacts to player behavior, increasing anxiety through environmental changes and unsettling narrative feedback.

**Tags:**
- Unity | C# | Unity Input System | TextMeshPro | Scriptable Architecture | Raycasting | Persistent Data

**Platform Badge:** `PC / Windows · Console`

**Store Links (inside card or modal):**
- Steam (Demo + Full Version)
- Epic Games Store (Demo + Full Version)
- Xbox
- PlayStation
...
**Project Title:** The Curse 404 — A Descent into Digital Madness
...
**Platform:** PC / Windows · Console (Steam · Epic Games · Xbox · PlayStation)
...
**Card Description:**
Fast Gear is a high-intensity 3D car racing game offering both thrilling single-player career modes and competitive real-time online multiplayer. Master realistic driving physics and race through dynamic tracks across cities, deserts, and forests. Released on Steam, Epic Games, Xbox, and PlayStation.

**Tags:**
- Unity 3D | C# | Multiplayer Networking | Physics Simulation | AI Programming | 3D Modeling | UI/UX Design

**Platform Badge:** `PC · Console`
...
**Project Title:** Fast Gear — Ultimate Racing Experience
...
**Platform:** PC · Console (Steam · Epic Games · Xbox · PlayStation)
...
**Card Description:**
Superdash is an offline-first hyper-casual mobile game featuring vibrant merge-and-match gameplay with intuitive swipe controls. Designed for play anywhere without an internet connection, the game rewards performance with a star rating system that keeps players coming back.

**Tags:**
- Unity | C# | SQLite | 2D Animation | Addressables | Collider2D

**Platform Badge:** `Mobile`

**Store Links:**
- Google Play Store ⭐ 4.8 stars

---

### 🪟 Modal Popup

**Project Title:** Superdash – Play Anywhere, No Internet Needed
...
**Platform:** Mobile (Android — Google Play Store)

**Store Stats:** ⭐ 4.8 stars · Available on Google Play
...
**Card Description:**
Puzzle Odyssey is an immersive cross-platform word puzzle game that blends challenging vocabulary gameplay with beautiful landscapes and calming soundtracks. Players swipe through letter grids to discover hidden words across stunning environments — available on iOS and Android.

**Tags:**
- Unity | C# | Shader Graph | Cinemachine | Post Processing | Unity IAP | Line Renderer | Collider2D | PlayerPrefs

**Platform Badge:** `Mobile`

**Store Links:**
- Google Play Store ⭐ 4.4 stars · 100+ installs
- App Store (iOS)
...
**Project Title:** Puzzle Odyssey — Words Meet Wonder
...
**Technologies Used:**
`Unity` `C#` `Shader Graph` `Cinemachine` `Post Processing` `Unity IAP` `Line Renderer` `Collider2D` `PlayerPrefs` `PlayFab`

**Platform:** Mobile (iOS & Android)

**Store Stats:** ⭐ 4.4 stars · 100+ installs · Available on Google Play & App Store

> *Developed as part of a professional team.*

---

## 📌 Notes for Developer / AI Populating the Portfolio

1. **"Developed as part of a professional team"** — add this as a small italicized line at the bottom of each modal. It's honest and signals professionalism.

2. **Store badges** — for Puzzle Odyssey and Superdash, use the official Google Play badge image. For The Curse 404 and Fast Gear, use Steam, Epic, Xbox, and PlayStation badge icons. Show these prominently inside the modal and consider showing a smaller badge on the card itself.

3. **Star ratings** — display as a visual star row (e.g. ★★★★☆) next to the Play Store badge on the card for Puzzle Odyssey (4.4) and Superdash (4.8).

4. **"Live Demo" button label** — rename to "View on Steam", "View on Play Store", or "View on Epic Games" depending on the game, for clarity.

5. **Card description length** — keep card descriptions to 2–3 sentences max. The full detail lives in the modal.

6. **Technology tags** — on the card, show only the top 4–5 most recognizable tags (Unity, C#, and 2–3 key ones). Show the full list inside the modal under "Technologies Used".
